export default function MetricCard({ header, link, metric, isCurrency }) {
  return (
    <div className="metric-card bg-black/5 dark:bg-white/5 border border-gray-500 dark:border-gray-500 rounded-lg p-4 max-w-72 w-full opacity-[.9] hover:opacity-100">
      <a
        aria-label={header}
        target="_blank"
