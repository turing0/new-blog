...
export default function ResearchLayout({
  children,
  research
}: PropsWithChildren<{ research: Research }>) {
  return (
    <Container
      title={`${research.title} - Code Snippet`}
      description="A collection of code snippets – related to Next.js, CSS, LaTeX, Matlab and others."
    >
      <article className="flex flex-col text-justify justify-center items-start max-w-2xl mx-auto mb-16 w-full">
