      ...
      <div className="flex flex-col items-start justify-center max-w-2xl mx-auto mb-16">
        ...
        <div className="relative w-full mb-4">
          <input
            ...
            className="block w-full px-4 py-2 text-gray-800 border border-1 border-gray-800 rounded-md dark:border-gray-300 focus:ring-blue-500 focus:border-blue-500 bg-[#faf6f1] dark:bg-gray-800 dark:text-gray-100"
          />
          <svg
