...
The National eligibility test(NET) is conducted by National Testing Agency(NTA) on
behalf of CSIR and UGC. A number of candidate who get good ranks are declared JRF
and such candidates are eligible for fellowship if they apply for the research in
India.
...
<Callout emoji="💡">
  Bank account should not be Jan-Dhan account/any such bank account having upper
  limit on incoming funds.
</Callout>
<ProsCard
  title="Bank account should be"
  pros={[
